    ...
    switch (msg.type) {
      case "plugin:ready":
        post({
          ...
          node: opts.node,
          theme: opts.theme,
          width: opts.node.rect.w,
          height: opts.node.rect.h,
        });
        break;
      case "plugin:resize":
      ...
      case "host:call": {
        ...
        const arg =
          typeof msg.params?.capability === "string"
            ? msg.params.capability
            : undefined;
        if (!hasPermission(opts.permissions, need, arg)) {
          ...
          post({
            ...
            error: {
              ...
              message: `method ${method} requires ${need}`,
            },
          });
          return;
        }
        ...
        try {
          ...
          post({
            ...
            id,
            ok: false,
            error: { code: "host_error", message: String(e) },
          });
        }
        break;
      }
