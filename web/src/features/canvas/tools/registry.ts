...
const isImageLike = (n: RawNode) =>
  n.type === 'image' || (n.type === 'generation' && hasVariant(n)) || n.type.startsWith('plugin:');
...
export const IMAGE_TOOLS: ToolDef[] = [
  ...
  { id: 'multiAngle', labelKey: 'canvas.tool.multiAngle', applies: isImageLike },
  { id: 'reversePrompt', labelKey: 'canvas.tool.reversePrompt', applies: isImageLike },
  { id: 'videoFrame', labelKey: 'canvas.tool.videoFrame', applies: (n) => n.type === 'video' || hasVideoVariant(n) },
];
