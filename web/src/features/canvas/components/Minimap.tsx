      ...
      {!collapsed && (
        <div
          ...
          onPointerDown={(e) => {
            ...
            const world = {
              x: bounds.x - pad + mx / scale,
              y: bounds.y - pad + my / scale,
            };
            kernel.viewport.focusRect(
              { ...view, x: world.x - view.w / 2, y: world.y - view.h / 2 },
              size,
              kernel.viewport.current.k,
            );
          }}
        >
            ...
            return (
              <span
                ...
                style={{
                  ...
                  background:
                    n.type === "group" ? "transparent" : minimapColor(n.type),
                  border:
                    n.type === "group" ? "1px dashed var(--ic-border)" : "none",
                  borderRadius: 2,
                  opacity: 0.85,
                }}
              />
